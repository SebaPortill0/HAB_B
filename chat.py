...
async def update_settings(settings):
    ...
    await cl.Message(content=f"Realizaré cualquier búsqueda en Internet desde {location}.", author="Jar3d👩‍💻").send()
...
async def start():
    ...
    await cl.Message(content=f"{jar3d_intro_hi}.\n\n Realizaré cualquier búsqueda en Internet desde los Estados Unidos.", author="Jar3d👩‍💻").send()
...
async def main(message: cl.Message):
    ...
    if message.content == "/end":
        ...
        if final_answer:
            ...
            await cl.Message(content="No se produjo una respuesta final.", author="Jar3d👩‍💻").send()
    else:
